    ...
    return (
        <div className={clsx("w-60 h-72 overflow-hidden m-4 bg-scondary rounded-xl flex flex-col items-stretch relative", className)}>
            ...
            <div className="h-full  px-4 pt-2 pb-5 flex flex-col items-start justify-between ">
                ...
                <div className="flex justify-between items-center w-full"><Rating color="FF7E5A" size={20} /> <div className="flex justify-center items-center text-sm font-medium"> {time} min <AiOutlineClockCircle className="ml-1" /></div></div>
